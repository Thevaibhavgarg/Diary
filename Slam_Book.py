...
def add_data():
	...
	window=LabelFrame(preview, text = "Diary Written:",font = ("Product Sans", 7, "bold"), fg = "red")
	window.pack(padx = 1, pady = 1, ipadx = 3, ipady = 3)
	window2=Frame(preview)
	window2.pack(padx = 1, pady = 1, ipadx = 3, ipady = 3)
	final=Text(window,font = ("Product Sans", 4),wrap="word",padx=3,pady=3)
	final.insert('1.0',readall)
	final.pack()
	submit_bttn=Button(window2, text = "Submit", width = 12,font = ("Product Sans", 10),command = final_data)
...
def add_entry_win():
	...
	#win_add_entry.geometry("900x900")
	win_add_entry.option_add('*Font','MiClock\ ExtraLight 8')
	Label(win_add_entry, text = "Fill all the details in reference of VAIBHAV",font = ("Product Sans", 7, "bold"), fg = "#ff6a00").pack()
	
	frm_ent_data = LabelFrame(win_add_entry, text = "Enter Details",font = ("Product Sans", 5))
	...
	lbl_nicname_add = Label(frm_ent_data, text = "Enter Nickname: ",font = ("Product Sans", 5))
	lbl_nicname_add.grid(row = 0, column = 0, padx = 3, pady = 3)
	ent_nicname_add = Entry(frm_ent_data,font = ("Product Sans", 5))
	ent_nicname_add.grid(row = 0, column = 1, padx = 3, pady = 3)
	
	lbl_meet_add = Label(frm_ent_data, text = "Enter When We First Meet: ",font = ("Product Sans", 5))
	lbl_meet_add.grid(row = 1, column = 0, padx = 3, pady = 3)
	ent_meet_add = Text(frm_ent_data,font = ("Product Sans", 5),height="2",width="15",wrap="word")
	ent_meet_add.grid(row = 1, column = 1, padx = 3, pady = 3)
	
	lbl_inc_add = Label(frm_ent_data, text = "Enter Some Incidence with Me: ",font = ("Product Sans", 5))
	lbl_inc_add.grid(row = 2, column = 0, padx = 1, pady = 1)
	ent_inc_add = Text(frm_ent_data,font = ("Product Sans", 5),height="2",width="15",wrap="word")
	ent_inc_add.grid(row = 2, column = 1, padx = 3, pady = 3)
	
	
	lbl_learnt_add = Label(frm_ent_data, text = "Enter Something Learnt From Me: ",font = ("Product Sans", 5))
	lbl_learnt_add.grid(row = 3, column = 0, padx = 3, pady = 3)
	ent_learnt_add = Text(frm_ent_data,font = ("Product Sans", 5),height="2",width="15",wrap="word")
	ent_learnt_add.grid(row = 3, column = 1, padx = 3, pady = 3)

	lbl_advice_add = Label(frm_ent_data, text = "Enter Some Advice For Me: ",font = ("Product Sans", 5))
	lbl_advice_add.grid(row = 4, column = 0, padx = 3, pady = 3)
	ent_advice_add = Text(frm_ent_data,font = ("Product Sans", 5),height="2",width="15",wrap="word")
	ent_advice_add.grid(row = 4, column = 1, padx = 3, pady = 3)
	
	lbl_wishes_add = Label(frm_ent_data, text = "Any Wishies: ",font = ("Product Sans", 5))
	lbl_wishes_add.grid(row = 5, column = 0, padx = 3, pady = 3)
	ent_wishes_add = Text(frm_ent_data,font = ("Product Sans", 5),height="2",width="15",wrap="word")
	ent_wishes_add.grid(row = 5, column = 1, padx = 3, pady = 3)
	
	lbl_quote_add = Label(frm_ent_data, text = "Any Quote : ",font = ("Product Sans", 5))
	lbl_quote_add.grid(row = 6, column = 0, padx = 3, pady = 3)
	ent_quote_add = Text(frm_ent_data,font = ("Product Sans", 5),height="2",width="15",wrap="word")
	ent_quote_add.grid(row = 6, column = 1, padx = 3, pady = 3)
	
	lbl_contact_add = Label(frm_ent_data, text = "Contact Details: ",font = ("Product Sans", 5))
	lbl_contact_add.grid(row = 7, column = 0, padx = 3, pady = 3)
	
	lbl_mobileno_add = Label(frm_ent_data, text = "Mobile No.: ",font = ("Product Sans", 5))
	lbl_mobileno_add.grid(row = 8, column = 0, padx = 3, pady = 3)
	ent_mobileno_add = Entry(frm_ent_data,font = ("Product Sans", 5))
	ent_mobileno_add.grid(row = 8, column = 1, padx = 3, pady = 3)
	
	lbl_fb_add = Label(frm_ent_data, text = "Facebook: ",font = ("Product Sans", 5))
	lbl_fb_add.grid(row = 9, column = 0, padx = 3, pady = 3)
	ent_fb_add = Entry(frm_ent_data,font = ("Product Sans", 5))
	ent_fb_add.grid(row = 9, column = 1, padx = 3, pady = 3)
	
	lbl_ins_add = Label(frm_ent_data, text = "Instagram: ",font = ("Product Sans", 5))
	lbl_ins_add.grid(row = 10, column = 0, padx = 3, pady = 3)
	ent_ins_add = Entry(frm_ent_data,font = ("Product Sans", 5))
	...
	btn_clear_add = Button(frm_buttons,text = "Clear", width = 2,command = clr_employee,font = ("Product Sans", 5))
	btn_clear_add.grid(row = 0, column = 0, padx = 10, pady = 1)
	
	btn_submit_add = Button(frm_buttons, text = "Preview", width = 2,font = ("Product Sans", 5),command = add_data)
...
frm_main = Frame(root)
frm_main.pack()
lbl_name_add=Label(frm_main,text="Enter Your Name:",font = ("Product Sans", 5))
lbl_name_add.grid(row = 0, column = 0 ,padx = 3, pady = 3)
ent_name=Entry(frm_main,font = ("Product Sans", 5))
ent_name.grid(row = 0, column = 1 ,padx = 3, pady = 3)
frm_start=Frame(root)
frm_start.pack()#(pady = 30)
btn_start = Button(frm_start, text = "START", width = 12, bd = 3,font = ("Product Sans", 5),command = add_entry_win) 
btn_start.pack()
root.mainloop()